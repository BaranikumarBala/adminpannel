                ...
                <div className="navbar-container">
                    ...
                    <div className="navbar-right">
                        <ul className="navbar-menu"> 
                            <li className="menu-item menu-icon" onClick={GoToDashboard}><i className="icons"><FaTachometerAlt/></i>Dashboard</li>
                            <li className="menu-item menu-icon" onClick={GoToProducts}><i className="icons"><FaShoppingCart/></i>Products</li>
                            <li className="menu-item menu-icon" onClick={GoToAccounts}><i className="icons"><FaUser/></i>Accounts</li>
